...
import { ArrowLeft, Phone, MessageCircle, Calculator, Info } from 'lucide-react';
...
export default function PassengerVehicleDetailPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <Link to="/mobil-keluarga" className="inline-flex items-center gap-2 text-[#C90010] hover:underline mb-6">
        <ArrowLeft className="h-4 w-4" />
        Kembali ke Mobil Keluarga
      </Link>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
        ...
        <div>
          <SectionTitle icon={Info}>{vehicle.name}</SectionTitle>
          <p className="text-gray-600 mt-4 mb-6">{vehicle.description}</p>
